...
PROFILE_PATH = Path("output/results/calibration_profile.json")
REPORT_PATH = Path("output/results/merge_and_calibration_report.md")
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    parser.add_argument("--offset", type=Path, default=Path("output/results/offset_diagnostics.json"))
