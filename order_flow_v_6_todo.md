...
<!-- WHY: 版本号、标题与根目录文档一致，标记与修订 2.0 对齐的任务集。 -->
...
### 卡片 207
<!-- WHY: 为 TVTP 时变转移和方向性判断器提供稳定的慢变量输入。 -->
- **模块**：Data
- **标题**：宏观慢变量构建与落盘
...
### 卡片 302
<!-- WHY: 项目说明书要求固定两态，并输出 TVTP 系数与稳健性报告。 -->
- **模块**：Model
...
### 卡片 303
<!-- WHY: 强化 TVTP 驱动包含宏观慢变量，并落入 VALIDATION 流程。 -->
- **模块**：Model
- **标题**：TVTP-HMM / 宏观 + 微观驱动
...
### 卡片 401
<!-- WHY: Validator 需同步方向性分层统计，并与治理契约绑定。 -->
- **模块**：Validation
...
### 卡片 406
<!-- WHY: Validator 报告需加入方向性分层摘要，并与发布契约绑定。 -->
- **模块**：Validation
- **标题**：Validator 产出物固化
...
### 卡片 865
<!-- WHY: 扩展治理契约，覆盖 TVTP 两态与方向性判断器字段。 -->
- **模块**：Governance
