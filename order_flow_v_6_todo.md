...
- **Data**：101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 115, 116, 117, 305, 312

- **Model**：201, 202, 203, 204, 205, 206, 302, 303, 304

- **Decision**：501, 502, 503, 504, 505, 506, 601, 602, 603, 604
...
- **Monitoring**：306, 801, 802, 803, 808
...
- **输入**：X_t
- **输出**：`model/artifacts/market_regime_hmm.pkl`、`hmm_meta.json`
...
- **输出**：`output/results/qc/date=YYYY-MM-DD/` 指标文件与 `qc_summary.md`
- **关键步骤**：
