...
def _self_test():
    ...
    assert abs(bandwidth_2x - 2 * bandwidth_1x) < 1e-6, "Sampling rate should scale linearly"
    print(f"Test 3 - Sampling rate scaling: 1x={bandwidth_1x:.6f}, 2x={bandwidth_2x:.6f}")
