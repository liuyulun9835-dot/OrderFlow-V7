...
SCHEMAS: dict[str, Path] = {
    "results/merge_metrics.json": SCHEMA_ROOT / "results_merge_metrics.schema.json",
    "results/calibration_profile.json": SCHEMA_ROOT / "results_calibration_profile.schema.json",
}
