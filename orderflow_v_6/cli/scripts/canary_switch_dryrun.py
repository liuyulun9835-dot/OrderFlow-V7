...
DEFAULT_REPORT = Path("output/qa/canary_switch_dryrun.md")
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    parser.add_argument("--bar", type=Path, default=Path("output/qa/bar_continuity_report.json"))
    parser.add_argument("--tick", type=Path, default=Path("output/qa/tick_quality_report.json"))
    parser.add_argument("--calibration", type=Path, default=Path("output/results/calibration_profile.json"))
    parser.add_argument("--costs", type=Path, default=Path("output/qa/precheck_costs_report.json"))
    parser.add_argument("--merge-metrics", type=Path, default=Path("output/results/merge_metrics.json"))
